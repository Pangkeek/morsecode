...
export default function Home() {
  ...
  const targetLetters = mode === 'encode' ? targetLettersEncode : targetLettersDecode;
  ...
  React.useEffect(() => {
    const handleKeyDown = (e) => {
      if (e.code === 'Space' && !isSpacebarPressed) {
      ...
      } else if (mode === 'decode' && e.key.length === 1 && e.key.match(/[a-zA-Z]/)) {
        ...
        if (currentCharIndex < targetLetters.length) {
          ...
          const expectedLetter = Object.keys(morseCodeMap).find(key => morseCodeMap[key] === currentMorse);
      ...
      {isCompleted ? (
          ...
          <div>
            ...
            <div className='flex'>
              <div>
                ...
                <p className={`${spmono.className} text-[#EF4444] text-[20px]`}>{mode} word</p>
              </div>
              <div className="ml-10">
        ...
        <div className={`${isFading ? 'animate-fadeOut' : ''} flex flex-col items-center`}>
          ...
          <p className={`${spmono.className} text-[48px] font-bold mt-20 transition-colors duration-300 ${
            ...
            {isSuccess ? successDisplay : (charInput || <span className="text-[24px] text-[#9CA3AF]">type</span>)}
          </p>
          <div className="mt-30">
            <div className="bg-[#717171] text-[11px]">
                <p className={`${spmono.className} font-bold text-[#141720] mx-1`}>type - to input</p>
            </div>
            <div className="bg-[#717171] text-[11px]">
