...
function Mainlayout({ children }) {
  return (
    <div className="min-h-screen flex flex-col items-center bg-[#141720] px-4">
        <nav className='w-full flex justify-between px-22 py-16'>
            ...
            <div className={`${spmono.className} w-12 h-12 bg-[#252B3D] rounded-full flex items-center justify-center font-bold text-[14px] text-white outline outline-[#EF4444]`}>jp</div>
        </nav>
